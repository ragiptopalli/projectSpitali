 ...
 * @author Edmond
 */
public class Farmacisti extends Stafi{
    
    String fjalkalimi;

    public Farmacisti(String e, String m, char g, String d, String de, String fjalkalimi) throws SpitaliException {
        super(e, m, g, d, de);
